...
while True:
    ...
    if ad == 'l':
        ...
        STEERING_RIGHT_PWM = STEERING_CENTER_PWM - 60
        STEERING_LEFT_PWM = STEERING_CENTER_PWM + 60
        break
...
while True:
    ...
    if ad == '+':
        ...
        THROTTLE_FORWARD_PWM = THROTTLE_STOPPED_PWM - 50
        THROTTLE_REVERSE_PWM = THROTTLE_STOPPED_PWM + 50
        break
    pwm.set_pwm(13, 0, THROTTLE_STOPPED_PWM)
