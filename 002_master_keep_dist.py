...
def Steer(ang,direction):#1:Right,-1:left
    togikai_drive.Accel(PWM_PARAM,pwm,time,80)
...
try:
    while True:
        ...
        if FRdis>20 and R_L_dis<20:
            #直進
            Accel(100)
        elif FRdis<50 and L_dis<20 and R_dis>20:
            #カーブがあるとき右まわり
            Steer(100,1)
        elif FRdis>20 and L_dis>40:
            #右からの左まわり
            Steer(100,-1)
        elif FRdis<50 and R_L_dis<20:
            Steer(100,1)

        elif FRdis>20 and R_L_dis>20 and L_dis>40:
            #壁から離れたら接近
            Steer(50,-1)
